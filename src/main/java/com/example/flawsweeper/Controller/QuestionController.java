...
public class QuestionController {
    ...
    public Result<Integer> addQuestion(@RequestBody ErrorQuestion question, RedirectAttributes attributes,@RequestHeader String Authorization) throws IOException {
        //  获取当前用户的id
